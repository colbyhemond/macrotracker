    ...
    return (<>
        <div className="flex flex-col ">
            ...
            <h1 className="text-center text-slate-700 font-extrabold text-2xl">Enter Macros</h1>
                ...
                {/* <MacroInput label="Fat" props={fatInput} onChange={handleFatChange} value={fat}/>
                <MacroInput label="Carbs" props={carbInput} onChange={handleCarbChange} value={carb}/>
                <MacroInput label="Protein" props={proteinInput} onChange={handleProteinChange} value={protein}/> */}
            </form>
