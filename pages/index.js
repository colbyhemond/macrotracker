  ...
  return (<>
      ...
      <div className='bg-base-300 bg-gradient-to-br from-indigo-950'>
        ...
        <div className='py-10 mt-10 m-auto prose'>
          ...
          <p>We shouldn't be tied to our phones when we should be focusing on ourselves. We've eliminated the all encompassing health app features and included only the necessary elements.</p>
          ...
          <p>Not focusing on overall calories consumed, but rather how many macro of each macronutrient you've consumed provides a guide for a better balanced diet throughout the day.</p>
